Feature: [SUC:09-12]-Find Taxpayer
  ...
  Scenario Outline: UAT_M4-12-01-Verify the fields in Find Taxpayer Returns screen
    ...
    Then Verify presence of fields tin "SearchForm:tin" and period number "SearchForm:periodnumber" and period year "SearchForm:periodyear" and search button "SearchForm:j_idt40" and cancel button "SearchForm:Cancel" and continue button "SearchForm:j_id14" in find return page
    ...
    Examples:
      ...
      | TIN | Taxpayer Name | Return Type | Period | Document Reference | Submission Date | FlexibleFormEntity:tin | FlexibleFormEntity:taxpayerName | FlexibleFormEntity:tradingName | FlexibleFormEntity:postalAddress | FlexibleFormEntity:email | FlexibleFormEntity:telephone | FlexibleFormEntity:periodFrom_input | FlexibleFormEntity:periodTo_input | FlexibleFormEntity:T_Items:j_id1 | FlexibleFormEntity:T_Items:j_id2 | FlexibleFormEntity:T_Items:j_id3 | FlexibleFormEntity:T_Items:j_id4 | FlexibleFormEntity:T_Items:j_id5 | FlexibleFormEntity:T_Items:j_id6 |
  ...
  Scenario Outline: UAT_M4-12-02-Verify the fields in Find Taxpayer Returns screen
    ...
    Examples:
      ...
      | FlexibleFormEntity:tin | FlexibleFormEntity:taxpayerName | FlexibleFormEntity:tradingName | FlexibleFormEntity:postalAddress | FlexibleFormEntity:email | FlexibleFormEntity:telephone | FlexibleFormEntity:periodFrom_input | FlexibleFormEntity:periodTo_input | FlexibleFormEntity:T_Items:j_id1 | FlexibleFormEntity:T_Items:j_id2 | FlexibleFormEntity:T_Items:j_id3 | FlexibleFormEntity:T_Items:j_id4 | FlexibleFormEntity:T_Items:j_id5 | FlexibleFormEntity:T_Items:j_id6 |
